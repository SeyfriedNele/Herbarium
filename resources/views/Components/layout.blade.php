    ...
    <body class="h-full  text-white min-h-screen">
        ...
        <nav class="bg-black/100">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="shrink-0">
                    <img src="/images/duckPointingFingers.png" alt="Your Company" class="size-8" />
                </div>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                        ...
                        <img src="/images/duckCrossedArms.png" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                    </button>
            ...
            <div class="border-t border-white/10 pt-4 pb-3">
                ...
                <div class="shrink-0">
                    <img src="/images/duckCrossedArms.png" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                </div>
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Simela Seyfried</div>
                    <div class="text-sm font-medium text-gray-400">simelasey@test.com</div>
                </div>
        ...
        <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
            <div class="mx-auto max-w-auto px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-green-500">{{ $heading }}</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-auto px-4 py-6 sm:px-6 lg:px-8">
